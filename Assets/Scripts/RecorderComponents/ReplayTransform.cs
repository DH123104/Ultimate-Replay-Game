        ...
        private void UpdateRotation(ReplayTime time, ReplayTransformSerializer.ReplayTransformSerializeFlags flags, bool interoplate)
        {
            ...
            if((flags & ReplayTransformSerializer.ReplayTransformSerializeFlags.LocalRot) != 0)
            {
                ...
                else
                {
                    ...
                    float x = ((flags & ReplayTransformSerializer.ReplayTransformSerializeFlags.RotX) != 0) ? updateRotation.x : cachedTransform.localEulerAngles.x;
                    float y = ((flags & ReplayTransformSerializer.ReplayTransformSerializeFlags.RotY) != 0) ? updateRotation.y : cachedTransform.localEulerAngles.y;
                    float z = ((flags & ReplayTransformSerializer.ReplayTransformSerializeFlags.RotZ) != 0) ? updateRotation.z : cachedTransform.localEulerAngles.z;
